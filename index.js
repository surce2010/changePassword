    ...
    var req = http.request(options, function (res) {
        if (res.statusCode === 200) {
            ...
            res.on('data', function (data) {
                ...
                if ($('#labelMessage').text().indexOf('密码修改成功') > -1) {
                    if (times === chgTimes) {
